...
import { DynamicTablePickerPlugin, TablePickerPlugin } from './picker/table-picker-plugin';
        ...
        <ActionsPlugin>
          <div className="clear-both flex items-center justify-between gap-2 overflow-auto border-t p-1">
            ...
            <div className="flex flex-1 justify-end">
              ...
              <ShareContentPlugin />
              <ImportExportPlugin />
              <MarkdownTogglePlugin shouldPreserveNewLinesInMarkdown={true} transformers={ALL_TRANSFORMERS} />
