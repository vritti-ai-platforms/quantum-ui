...
type EditorConfig = Pick<
  RichTextEditorProps,
  'editorClassName' | 'maxLength' | 'onImageUpload' | 'onMentionSearch' | 'placeholder' | 'readOnly' | 'contentOnly'
>;
...
export function EditorConfigProvider({ children, value }: { children: React.ReactNode; value: EditorConfig }) {
