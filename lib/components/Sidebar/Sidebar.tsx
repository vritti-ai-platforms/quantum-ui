...
export type SidebarMode = ShadcnSidebarMode;
export const Sidebar = ShadcnSidebar;
export const SidebarContent = ShadcnSidebarContent;
export const SidebarControl = ShadcnSidebarControl;
...
export const SidebarMenu = ShadcnSidebarMenu;
export const SidebarMenuAction = ShadcnSidebarMenuAction;
export const SidebarMenuBadge = ShadcnSidebarMenuBadge;
export const SidebarMenuButton = ShadcnSidebarMenuButton;
export const sidebarMenuButtonVariants = shadcnSidebarMenuButtonVariants;
...
export const useSidebarMode = shadcnUseSidebarMode;
