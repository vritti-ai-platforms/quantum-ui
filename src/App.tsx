...
// // Override the internal axios adapter with mock API for development
...
//           {/* API Integration - Internal Axios */}
//           <Card>
//             <CardHeader>
//               <CardTitle>API Integration - Internal Axios Instance</CardTitle>
//               <CardDescription>Using internal pre-configured axios for mock API</CardDescription>
//             </CardHeader>
//             <CardContent>
//               <SingleSelect
//                 label="Users (Internal Axios)"
//                 value={apiUser}
//                 onChange={(val) => setApiUser(val as string | null)}
